...
public class GameplaySceneInstaller : MonoInstaller
{
    ...
    public override void InstallBindings()
    {
        if (_isMobileDevice)
        {
            ...
            MobilePickupMessage mobilePickupMessage = Container.InstantiatePrefabForComponent<MobilePickupMessage>(
                _mobilePickupMessage,
                Vector3.zero,
                Quaternion.identity,
                null);
        ...
        else
        {
            ...
            Container.BindInterfacesTo<DesctopInput>().AsSingle();

            DesktopPickupMessage desktopPickupMessage = Container.InstantiatePrefabForComponent<DesktopPickupMessage>(
                _desktopPickupMessage,
                Vector3.zero,
                Quaternion.identity,
                null);
